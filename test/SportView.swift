...
struct SportView: View {
    ...
    struct ContentViewSport: View {
        let frontContents = [" Team sports, Outdoor activities", "Moderate activity with occasional challenges, Mix of team and solo activities, Mix of indoor and outdoor activities, high budget", "Low-intensity and relaxed, Solo sports, Indoor"]
        let backContents = ["Sports: Soccer", "Tennis, Swimming", "Yoga, Table Tennis"]
